...
## Circuito
Cada iteração (loop de código) é realizada após uma combinação de um oráculo comum e um aplificador (que contem um oráculo condicional, ou oráculo , ao final de todas iterações iremos realizar uma medição em cada qubit
